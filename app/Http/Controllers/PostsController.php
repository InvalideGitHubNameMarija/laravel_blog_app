...
class PostsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/posts')->with('success','Post je editovan');
    ...
    public function destroy($id)
    {
      ...
      //provera korektnog usera
        ...
        $post->delete();
        return redirect('/posts')->with('success','Post je obrisan');
